...
namespace ResoniteNoResetScale
{
    public class ResoniteNoResetScale : ResoniteMod
    {
        public override string Name => "ResoniteNoResetScale";
        public override string Author => "runtime, NepuShiro";
        public override string Version => "2.0.0";
        public override string Link => "https://github.com/NepuShiro/ResoniteNoResetScale";
        ...
        {
            Harmony harmony = new Harmony("net.michaelripley.ResoniteNoResetScale");
            ...
            harmony.Patch(asyncMethodBody, transpiler: new HarmonyMethod(AccessTools.DeclaredMethod(typeof(ResoniteNoResetScale), nameof(Transpiler))));
        }
